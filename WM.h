...
const char HTTP_HEAD[] PROGMEM                  = "<!DOCTYPE html><html lang=\"de\"><head><meta name=\"viewport\" content=\"width=device-width, initial-scale=1, user-scalable=no\"/><title>{v}</title><link rel='icon' type='image/x-icon' href='/favicon.png'>";
const char HTTP_HEAD_END[] PROGMEM              = "</head><body><div style='text-align:left;display:inline-block;width:-webkit-fill-available;'>";
const char HTTP_ITEM[] PROGMEM                  = "<div><a href='#p' onclick='c(this)'>{v}</a>&nbsp;<span class='q {i}'>{r}%</span></div>";
const char HTTP_BUTTON_CHIPINFO[] PROGMEM       = "<form action=\"/i\" method=\"get\"><button>Chip-Info</button></form><br/>";
const char HTTP_BUTTON_RESTART[] PROGMEM        = "<form action=\"/r\" method=\"post\"><button>Restart</button></form></br>";
const char HTTP_BUTTON_FACTORYRESET[] PROGMEM   = "<form action=\"/c\" method=\"post\"><button>Factory Reset</button></form>";
const char HTTP_BUTTON_CONFIG_WIFI_AP[] PROGMEM = "<form action=\"/wifi\" method=\"get\"><button>Konfiguration WIFI</button></form><br/><br/>";
const char HTTP_BUTTON_LED_AP[] PROGMEM         = "<form action=\"/LED\" method=\"get\"><button>LED</button></form><br/>";
